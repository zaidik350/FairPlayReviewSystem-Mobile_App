...
export default function DecisionResult({ decision, originalDecision }: DecisionResultProps) {
  ...
  return (
    <Card variant="elevated" style={styles.card}>
      ...
      <View style={styles.comparison}>
        ...
        <Text style={[styles.compValue, { color: matches ? Colors.out : Colors.notOut }]}>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 14, color: Colors.textSecondary, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 16 },
  explanation: { fontSize: 13, color: Colors.textSecondary, textAlign: 'center', marginTop: 16, lineHeight: 20 },
  comparison: { flexDirection: 'row', alignItems: 'center', marginTop: 16, paddingTop: 16, borderTopWidth: 1, borderTopColor: Colors.cardBorder, gap: 8 },
